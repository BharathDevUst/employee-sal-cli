        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'Add Employee': return [3 /*break*/, 3];
                        case 'Find Employees by Department': return [3 /*break*/, 5];
                        case 'Exit': return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 8];
                case 3: return [4 /*yield*/, employeeController.addEmployee()];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 5: return [4 /*yield*/, employeeController.findEmployeesByDepartment()];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 7:
